...
public class ORDSTests {
    ...
    //#TASK: get employee with id 100 and verify response returns status code 200
    //also print body
    @Test
    public void test2(){
        ...
        //when put header info "Accept", "application/json", we are saying that we need only json as response
